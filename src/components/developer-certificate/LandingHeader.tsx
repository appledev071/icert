    ...
    <header className="flex justify-between items-center py-6 mb-16 animate-fade-in-up">
      ...
      <div className="flex items-center gap-6">
        ...
        <a href="https://t.me/icertstoremanager" target="_blank" rel="noopener noreferrer" 
           className="bg-black dark:bg-theme-blue dark:text-white text-white py-2 px-5 rounded-full text-sm font-medium hover:bg-gray-800 dark:hover:bg-blue-600 transition-all relative group overflow-hidden shine-effect">
