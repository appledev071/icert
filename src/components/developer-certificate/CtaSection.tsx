...
export const CtaSection: React.FC = () => {
  ...
  return (
    <section className="py-24 animate-fade-in-up" style={{ animationDelay: "0.5s" }}>
      <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-16 text-center relative overflow-hidden group hover:border-theme-blue/30 transition-all duration-500">
        ...
        <h2 className="text-3xl sm:text-4xl font-bold font-montserrat mb-6 text-black dark:text-white relative inline-block">
                ...
                <Link to="/developer-certificate-info" onClick={scrollToTop}>
                  <Button 
                    ...
                    className="border-gray-300 dark:border-gray-700 text-gray-800 dark:text-gray-200 
                              text-base py-3 px-10 rounded-full group hover:border-theme-blue/50 
